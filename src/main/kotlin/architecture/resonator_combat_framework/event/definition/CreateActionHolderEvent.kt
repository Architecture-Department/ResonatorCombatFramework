 ...
 */
class CreateActionHolderEvent : Event() {
	companion object {
		private lateinit var MAP_CACHE: HashMap<EntityType<*>, (LivingEntity) -> ActionHolder<*>>
		private val MAP = hashMapOf<Supplier<EntityType<*>>, (entity: LivingEntity) -> ActionHolder<*>>()

		@JvmStatic
		fun getAll(): Map<EntityType<*>, (entity: LivingEntity) -> ActionHolder<*>> {
	...
	fun register(entityType: Supplier<EntityType<*>>, function: (entity: LivingEntity) -> ActionHolder<*>) {
