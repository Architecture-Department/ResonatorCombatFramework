 ...
 */
class MolangScopeHolder(private val global: MolangDataHolder) : MolangDataHolder() {
...
fun <T> MolangDataHolder.withScope(block: (MolangScopeHolder) -> T): T {
	val scope = MolangScopeHolder(this)
	return block(scope)
}
